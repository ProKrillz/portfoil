<script>
    import Projects from "../storges/Storges.js"
...
<div class="project-form">  
    ...
    <div class="project" >
        <svg on:click={() => toggleModal(project)} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
